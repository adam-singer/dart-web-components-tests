...
import '_TodoItemComponent.dart.dart';
...
void init_autogenerated() {
  ...
  autogenerated.Node _endPosition__e2;
  ...
  _stoppers2.add(autogenerated.watchAndInvoke(() => todoItems, (_) {
    ...
    for (var x in todoItems) {
      ...
      autogenerated.insertAllBefore(__e2.parent, __insert___e2,
      
      [_endPosition__e2 = new autogenerated.Element.html('<li><x-todo-item id="__e-1"></x-todo-item></li>')]);
