...
$$._HashMapImpl = {"":"Object;_lib0_keys,_values,_loadLimit,_numberOfEntries,_numberOfDeleted",
 ...
 _probeForLookup$1: function(key) {
  ...
  if (key == null)
    throw $.$$throw($.ArgumentError$(null));
  hash = $.and($.getInterceptor(key).get$hashCode(key), this._lib0_keys.length - 1);
  if (hash !== (hash | 0))
 ...
 _grow$1: function(newCapacity) {
  ...
  this._lib0_keys = $.List_List(newCapacity);
...
$$._LinkedHashMapImpl = {"":"Object;_lib0_list,_map",
 ...
 get$values: function() {
  ...
  list = $.List_List(this.get$length());
  t1.index_1 = 0;
  this._lib0_list.forEach$1(new $._LinkedHashMapImpl_values_anon(list, t1));
  return list;
},
 forEach$1: function(f) {
...
$$.Fancy = {"":"WebComponent;_root,_element,_shadowRoots",
...
$$.main_anon = {"":"Closure;",
 call$0: function() {
  $.query("x-fancy").get$xtag().beFancy$0();
}
};
...
$.Fancy$forElement = function(e) {
  var t1 = new $.Fancy(null, e, null);
...
//@ sourceMappingURL=CallMethodOnCustomElement.html_bootstrap.dart.js.map