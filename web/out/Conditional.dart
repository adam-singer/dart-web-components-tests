...
void init_autogenerated() {
  ...
  __stoppers2.add(autogenerated.watchAndInvoke(() => langChoice != null && !langChoice.isEmpty, (__e) {
    ...
    if (_isVisible__e6 && !showNow) {
      ...
      __e6.nextNode.remove();
      
    } else if (!_isVisible__e6 && showNow) {
      
      _isVisible__e6 = true;
      
      __e5 = new autogenerated_html.Element.html('<div template="" if="langChoice != null &amp;&amp; !langChoice.isEmpty">\n      <h3 id="__e-2"></h3>\n      \n      <code><pre id="__e-4"></pre></code>\n    </div>');
      ...
      __e6.parent.insertBefore(__e5, __e6.nextNode);
