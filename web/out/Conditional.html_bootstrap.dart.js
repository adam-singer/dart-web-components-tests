...
$$.init_autogenerated_anon1 = {"":"Closure;box_0",
 call$1: function(__e) {
  var showNow, t1, t2, t3;
  showNow = __e.get$newValue();
  t1 = this.box_0;
  t2 = t1._isVisible__e6_2 === true;
  if (t2 && showNow !== true) {
    t1._isVisible__e6_2 = false;
    t1.__e5_3 = null;
    t1.__e2_4 = null;
    t2 = t1.__stoppers3_1_6;
    t3 = $.getInterceptor$JSArray(t2);
    t3.forEach$1(t2, new $.init_autogenerated__anon());
    t3.clear$0(t2);
    t1.__binding1_5 = null;
    t1.__e4_7 = null;
    t1.__binding3_8 = null;
    t1.__e6_1.get$nextNode().remove$0();
  } else if (!t2 && showNow === true) {
    t1._isVisible__e6_2 = true;
    t1.__e5_3 = $.Element_Element$html("<div template=\"\" if=\"langChoice != null &amp;&amp; !langChoice.isEmpty\">\n      <h3 id=\"__e-2\"></h3>\n      \n      <code><pre id=\"__e-4\"></pre></code>\n    </div>");
    t1.__e2_4 = t1.__e5_3.query$1("#__e-2");
    t1.__binding1_5 = $.Text_Text("");
    t1.__stoppers3_1_6 = [];
    t2 = t1.__e2_4.get$nodes();
    $.getInterceptor$JSArray(t2).add$1(t2, t1.__binding1_5);
    t1.__e4_7 = t1.__e5_3.query$1("#__e-4");
    t1.__binding3_8 = $.Text_Text("");
    t2 = t1.__e4_7.get$nodes();
    $.getInterceptor$JSArray(t2).add$1(t2, t1.__binding3_8);
    t1.__e6_1.get$parent().insertBefore$2(t1.__e5_3, t1.__e6_1.get$nextNode());
    t2 = t1.__stoppers3_1_6;
    $.getInterceptor$JSArray(t2).add$1(t2, $.watchAndInvoke(new $.init_autogenerated__anon0(), new $.init_autogenerated__anon1(t1), null));
    t2 = t1.__stoppers3_1_6;
    $.getInterceptor$JSArray(t2).add$1(t2, $.watchAndInvoke(new $.init_autogenerated__anon2(), new $.init_autogenerated__anon3(t1), null));
  }
}
};
...
$$.init_autogenerated__anon1 = {"":"Closure;box_0",
 call$1: function(__e) {
  ...
  t1 = $.langChoice;
  t2 = this.box_0;
  t2.__binding1_5 = $.updateBinding(t1, t2.__binding1_5, __e.get$newValue());
}
};
...
$$.init_autogenerated__anon3 = {"":"Closure;box_0",
 call$1: function(__e) {
  var t1, t2;
  t1 = $.example;
  t2 = this.box_0;
  t2.__binding3_8 = $.updateBinding(t1, t2.__binding3_8, __e.get$newValue());
}
};
...
$.chooseExample = function(e) {
  $.langChoice = e.get$target().get$value();
  $.example = $.index($.get$languageExamples(), $.langChoice);
};
...
$.init_autogenerated = function() {
  var t1, _root, __e0, __stoppers2, __listener__e0_change_1, t2;
  t1 = {};
  ...
  t1.__e2_4 = null;
  t1.__binding1_5 = null;
  t1.__stoppers3_1_6 = null;
  t1.__e4_7 = null;
  t1.__binding3_8 = null;
  __e0 = _root.query$1("#__e-0");
  t1.__e6_1 = _root.query$1("#__e-6");
  __stoppers2 = [];
  __listener__e0_change_1 = new $.init_autogenerated_anon();
  t2 = __e0.get$on().get$change();
  $.getInterceptor$JSArray(t2).add$1(t2, __listener__e0_change_1);
...
Isolate.$lazy($, 'languageExamples', 'languageExamples', 'get$languageExamples', function() {
  return $.makeLiteralMap(["js", "function Person(firstName, lastName) {\n  this.firstName;\n  this.lastName;\n};\n", "java", "public class Person {\n  private String firstName;\n  private String lastName;\n  Person(firstName, lastName) {\n    this.firstName = firstName;\n    this.lastName = lastName;\n  }\n  public String getFirstName() {\n    return firstName;\n  }\n  public void setFirstName(String firstName) {\n    this.firstName = firstName;\n  }\n  public String getLastName() {\n    return lastName;\n  }\n  public void setLastName(String lastName)  [\n    this.lastName = lastName;\n  }\n}\n"]);
});
...
//@ sourceMappingURL=Conditional.html_bootstrap.dart.js.map