...
$$.init_autogenerated_anon = {"": ["box_0"],
 "super": "Closure",
 call$1: function(__e) {
  $.acceptLicense = this.box_0._acceptLicense_1.get$checked();
  $.dispatch();
}
};
...
$$.init_autogenerated_anon1 = {"": ["box_0"],
 "super": "Closure",
 call$1: function(__e) {
  var t1 = __e.get$newValue();
  this.box_0._acceptLicense_1.set$checked(t1);
}
};
...
$$.init_autogenerated_anon3 = {"": ["box_0"],
 "super": "Closure",
 call$1: function(__e) {
  var showNow, t1, t2, t3, t4, _endPosition__e0;
  showNow = __e.get$newValue();
  t1 = this.box_0;
  t2 = t1._isVisible__e0_4 === true;
  if (t2 && showNow !== true) {
    t1._isVisible__e0_4 = false;
    t1._endPosition__e0_3 = $.removeNodes(t1.__e0_2, t1._endPosition__e0_3);
  } else if (!t2 && showNow === true) {
    t1._isVisible__e0_4 = true;
    t2 = t1.__e0_2.get$parent();
    t3 = t1.__e0_2.get$nextNode();
    t4 = $.Element_Element$html('<h2>Thanks!</h2>');
    _endPosition__e0 = $.Element_Element$html('<p>We\'ll send the activation key to your email.</p>');
    t1._endPosition__e0_3 = _endPosition__e0;
    $.insertAllBefore(t2, t3, [t4, _endPosition__e0]);
  }
}
};
...
$.init_autogenerated = function() {
  var t1, _root, _stoppers2, _listener_acceptLicense_click_1, t2;
  t1 = {};
  ...
  t1._acceptLicense_1 = null;
  t1.__e0_2 = null;
  t1._endPosition__e0_3 = null;
  t1._isVisible__e0_4 = false;
  t1._acceptLicense_1 = _root.query$1('#accept-license');
  _stoppers2 = [];
  t1.__e0_2 = _root.query$1('#__e-0');
  _listener_acceptLicense_click_1 = new $.init_autogenerated_anon(t1);
  t2 = t1._acceptLicense_1.get$on().get$click();
  $.getInterceptor(t2).add$1(t2, _listener_acceptLicense_click_1);
  $.getInterceptor(_stoppers2).add$1(_stoppers2, $.watchAndInvoke(new $.init_autogenerated_anon0(), new $.init_autogenerated_anon1(t1), null));
  t1._endPosition__e0_3 = t1.__e0_2;
  $.getInterceptor(_stoppers2).add$1(_stoppers2, $.watchAndInvoke(new $.init_autogenerated_anon2(), new $.init_autogenerated_anon3(t1), null));
...
//@ sourceMappingURL=simple_conditional.html_bootstrap.dart.js.map