...
$.init_autogenerated = function() {
  var t1, _root, __e1, __stoppers1, t2, __changeIt, __listener__changeIt_click_2;
  t1 = {};
  ...
  __changeIt = _root.query$1("#change-it");
  __stoppers1.push($.watchAndInvoke(new $.init_autogenerated_anon(), new $.init_autogenerated_anon0(t1), null));
  __listener__changeIt_click_2 = new $.init_autogenerated_anon1();
  t2 = __changeIt.get$on().get$click();
  $.getInterceptor$JSArray(t2).add$1(t2, __listener__changeIt_click_2);
};
