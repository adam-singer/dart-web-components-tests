...
$$._ForwardingStreamSubscription = {"": "Object;_stream,_liblib2$_onData,_onError,_onDone,_liblib2$_subscription",
  ...
  cancel$0: function() {
    var t1 = this._liblib2$_subscription;
    if (t1 == null)
      throw $.$$throw($.StateError$("Subscription has been unsubscribed"));
    t1.cancel$0();
    this._liblib2$_subscription = null;
  },
  ...
  _ForwardingStreamSubscription$5: function(_stream, _onData, _onError, _onDone, unsubscribeOnError) {
    ...
    this._liblib2$_subscription = t1.listen$4$onDone$onError$unsubscribeOnError(t2, this.get$_handleDone(), t3, unsubscribeOnError);
  }
};
...
$$.init_autogenerated_anon0 = {"": "Closure;",
  call$1: function($$event) {
    $.superlative = $.$$index($.alternatives, $.get$random().nextInt$1(3));
  },
  $isFunction: true
};
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    if ($.contains0(window.get$navigator().get$userAgent(), "Opera", 0) !== true && $.contains0(window.get$navigator().get$userAgent(), "MSIE", 0) === true && $.CONSTANT6.containsKey$1(tag) === true)
      return $._ElementFactoryProvider__createTableForIE(html, tag);
    parentTag = $.CONSTANT7.$index(tag);
    if (parentTag == null)
      parentTag = "div";
  } else {
    parentTag = "div";
...
$.init_autogenerated = function() {
  ...
  __binding0 = __t.contentBind$1(new $.init_autogenerated_anon());
  $.addAll(__e1.get$nodes(), [$.Text_Text("MDV is "), __binding0]);
  __t.listen$2(_root.query$1("#change-it").get$onClick(), new $.init_autogenerated_anon0());
  __t.create$0();
  __t.insert$0();
};
...
$.CONSTANT11 = Isolate.makeConstantList(["wicked cool", "sweet", "fantastic"]);
$.CONSTANT12 = Isolate.makeConstantList(["caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr"]);
$.CONSTANT6 = new Isolate.$isolateProperties.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, Isolate.$isolateProperties.CONSTANT12);
...
$.superlative = "awesome";
$.alternatives = Isolate.$isolateProperties.CONSTANT11;
$._watchers = null;
